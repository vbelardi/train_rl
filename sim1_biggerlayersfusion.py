...
class Custom3DGridExtractor(BaseFeaturesExtractor):
    def __init__(self, observation_space, features_dim=256):
        ...
        self.fuse = nn.Sequential(
            nn.Linear(flat+64,4096), nn.ReLU(),
...
if __name__ == "__main__":
    ...
    cb = CheckpointCallback(save_freq=50_000, save_path="./sim1biglayfusion/", name_prefix="sim1_biglayfusion_check")
    ...
    model.save("sim1_biglayfusion_final")