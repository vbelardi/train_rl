...
class Custom3DGridExtractor(BaseFeaturesExtractor):
    def __init__(self, observation_space, features_dim=256):
        ...
        self.pos_mlp = nn.Sequential(
            nn.Linear(drone_shape[0], 64), nn.ReLU(),
            nn.Linear(64,128), nn.ReLU(),
            nn.Linear(128,256), nn.ReLU(),
        )
        # fusion
        self.fuse = nn.Sequential(
            nn.Linear(flat+256,2048), nn.ReLU(),
...
if __name__ == "__main__":
    ...
    cb = CheckpointCallback(save_freq=50_000, save_path="./sim1biglaypos/", name_prefix="sim1_biglaypos_check")
    ...
    model.save("sim1biglaypos_final")