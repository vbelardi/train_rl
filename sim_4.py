...
import voxelgrid
from gym_neg_incr_with_steps import DroneExplorationEnv
...
if __name__ == "__main__":
    ...
    cb = CheckpointCallback(save_freq=50_000, save_path="./sim4/", name_prefix="sim4_check")
