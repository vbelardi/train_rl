...
class Custom3DGridExtractor(BaseFeaturesExtractor):
    def __init__(self, observation_space, features_dim=256):
        ...
        self.cnn3d = nn.Sequential(
            ...
            nn.Conv3d(32, 64, (5,5,3), (2,2,1), (1,1,1)), nn.ReLU(),
            nn.Conv3d(64,64,3,2,1), nn.ReLU(),
            nn.Conv3d(64,128,3,2,1), nn.ReLU(),
            nn.Conv3d(128,128,3,1,1), nn.ReLU(),
            nn.Conv3d(128,256,3,1,1), nn.ReLU(),
            nn.Conv3d(256,256,3,1,1), nn.ReLU(),
            nn.Flatten()
        )
        with torch.no_grad():
            d = D//4; h = H//4; w = W//4
...
if __name__ == "__main__":
    ...
    cb = CheckpointCallback(save_freq=50_000, save_path="./sim1_cnnlotbiglayers/", name_prefix="sim1_cnnlotbiglayers_check")
    ...
    model.save("sim1_cnnlotbiglayers_final")