...
class Custom3DGridExtractor(BaseFeaturesExtractor):
    def __init__(self, observation_space, features_dim=256):
        ...
        self.cnn3d = nn.Sequential(
            ...
            nn.MaxPool3d((2,2,1), (2,2,1)),  # Added max pooling
            
            nn.Conv3d(32, 32, (5,5,3), (1,1,1), (2,2,1)), nn.ReLU(),
            nn.MaxPool3d((2,2,1), (2,2,1)),  # Added max pooling
            
            nn.Conv3d(32, 64, 3, 1, 1), nn.ReLU(),
            nn.MaxPool3d(2, 2),  # Added max pooling
...
if __name__ == "__main__":
    ...
    cb = CheckpointCallback(save_freq=50_000, save_path="./sim1cnnmaxpool/", name_prefix="sim1_cnnmaxpool_check")
    ...
    model.save("sim1cnnmaxpool_final")